...
function AccountProfile({ profileName, accountImg, role, description, state, country }) {
  ...
  return (
    <div className={classes.grid}>
      <div />
      <div>
        <Avatar src={accountImg} className={classes.xl} style={{ float: 'left' }} />
      </div>
      <div className={classes.avatarTitle}>
        <h1 style={{ margin: '5px' }}>
          {profileName} <span style={{ fontSize: '1rem', color: '#C0C0C0', fontFamily: 'italic' }}>{role}</span>
        </h1>
        <p style={{ margin: '5px' }}>
          {' '}
        ...
        <p style={{ margin: '2px' }}>
          <PinDropIcon className={classes.sm} style={{ color: '#006772', marginLeft: '-5px' }} />
          {state}, {country}
        </p>
      </div>
      <div />
