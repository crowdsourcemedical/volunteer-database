...
const checkboxesListMock = [{ "label": "Medical staff", "status": false }, { "label": "Doctor", "status": false }, { "label": "Engineer", "status": false }] // pass this to a checkboxsection to output all checkbox labels -> status is if its disabled or enabled
...
const StoryBook = props =>  {
    ...
    return (
        ...
        <CheckBoxSection sectionHeader={"Staff required"} checkboxes={checkboxesListMock} cb ={handleCheckBoxSelection}></CheckBoxSection>
