...
export default class NewProject extends Component {
    ...
    checkboxesCad = [{ "label": "Solid Works", "status": false }, { "label": "Inventor", "status": false }] // pass this to a checkboxsection to output all checkbox labels -> status is if its disabled or enabled
    checkboxesMedical = [{ "label": "Registered Nurse", "status": false }, { "label": "Physician Assistant", "status": false }, { "label": "Medical Student", "status": false }, { "label": "Intern", "status": true }, { "label": "Resident", "status": false }, { "label": "Attending", "status": true }] // pass this to a checkboxsection to output all checkbox labels -> status is if its disabled or enabled
    checkboxesEng = [{ "label": "Mechanical Engineer", "status": false }, { "label": "Mechanical Engineer with FEA experience", "status": false }, { "label": "Electrical Engineer", "status": true }, { "label": "Mechatronics Engineer", "status": false }] // pass this to a checkboxsection to output all checkbox labels -> status is if its disabled or enabled
    checkboxesLegal = [{ "label": "Lawyer", "status": false }, { "label": "Barrister", "status": false }, { "label": "paralegal", "status": false }]
    checkboxesManu = [{ "label": "FDM 3D printer", "status": false }, { "label": "SLA 3D printer", "status": false }, { "label": "SLS Nylon 3D printer", "status": false }, { "label": "Machinist", "status": true }]
                ...
                <Grid container justify="center">
                    <Grid item xs={12} lg={8} xl={8}>
                        <Grid container alignItems="flex-start" item xs={12} lg={8} xl={8}>
                            <Typography color="primary" variant="h4">Tell us about your project.</Typography> <br></br>
                        </Grid>
                        <Grid container alignItems="flex-start" item xs={12} lg={8} xl={8}>
                        ...
                        <form className={useStyles.root} noValidate autoComplete="off">
                            ...
                            <TextField
                                ...
                                size="large"
                                label="Description"
                                variant="outlined" value={this.state.description} onChange={this.handleChange} />
                            <Box m={5} />
                            <Grid container alignItems="flex-start" item xs={12} lg={8} xl={8}>
                                < Typography id="legal_recomendations" color="primary" variant="subtitle1"> Please read the recomendatiosn from our Legal </Typography>
                                <Box m={3} />
                            ...
                            <Grid container alignItems="flex-start" item xs={12} lg={8} xl={8}>
                                <Typography variant="h5">Request Team Members and Advisors</Typography>
                                <Box m={5} />
