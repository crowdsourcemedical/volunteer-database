    ...
    <Grid container spacing={2}>
      ...
      <Grid container justify="center">
        ...
        <Grid item xs={8} lg={4} xl={4}>
          <Typography variant="h1">Welcome to Crowd Sourced Medical</Typography>
        </Grid>
      </Grid>
      <Box m={2} />
      <Grid container justify="center">
      ...
      <Grid container justify="center">
        <Grid item xs={12} lg={8} xl={8}>
          ...
          <Typography align="left" variant="body1">
            Hi, and thank you for your interest in helping bring people together
            in this time of need. Our Regulatory and Legal teams have a few
            recommendations regarding language to use in your project.
          </Typography>
          <Box m={2} />
          <Typography align="left" variant="body1">
          ...
          <Box m={2} />
          <Typography align="left" variant="body1">
            Words like "medical", "prevent", "protect", and "hospital" are going
            to put you at risk. Indicating your mask is for a non-medical
            purpose is not recommended, because the intent of this effort is
            clear to authorities. When packaging, distributing, or discussing
            these produced materials, we recommend using plain boxes wherever
